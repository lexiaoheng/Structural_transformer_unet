...
from networks.model import ST_U
...
parser.add_argument('--cfg', default='./configs/configs.yaml', type=str, metavar="FILE", help='path to config file', )
parser.add_argument(
        "--opts",
